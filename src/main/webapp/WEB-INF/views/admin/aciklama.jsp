			...
			<nav class="navbar navbar-inverse" role="navigation">
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav main_nav">
						...
						<li><a href='<s:url value="siyaset"></s:url>'>Spor</a></li>
						<li><a href='<s:url value="saglik"></s:url>'>Spor</a></li>
						<li><a href='<s:url value="ekonomi"></s:url>'>Spor</a></li>
					</ul>
				</div>
			</nav>
		</section>
      ...
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="left_content">
          <div class="single_page">
            ...
            <div class="single_page_content"> <img src="http://localhost:80/resim/server/php/files/<c:out value="${klasor}"></c:out>/<c:out value="${haberurl}"></c:out>"
									alt="">
              <p><c:out value="${detay}"></c:out></p>
